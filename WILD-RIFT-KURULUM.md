...
`npm run update:wild-rift:counters`: katalogdaki tüm Core rehberlerini eksik/eski kayıt ve popülerlik önceliğiyle kontrol eder. Altı saatlik önbellek ve kaynak hatasında bir saatlik bekleme uygulanır. Önceki ilişkiler kendi tarihiyle korunur. Kaynak tarihi bulunan WR-META önbelleği yeni indirme iddiası olmadan tekrar işlenir. Başarılı doğrulamada veri dosyası mevcut yerel GitHub eşitlemesine gönderilir. `-- --no-sync` sadece yerel doğrulama için gönderimi atlar.

Tam güncelleme de bu toplayıcıyı çalıştırır; tarayıcıdaki seçimler dış kaynakları sorgulamaz. Her kaydın koridoru, yönü ve yaması önemlidir. Kaynakların aynı eşleşmede uyuşması maç kazanma yüzdesi ya da bağımsız maç örneklemi anlamına gelmez. Eksik eşleşme dengeli kabul edilmez. 25 Eylül tam taraması 142/142 şampiyonda başarılıdır. 1.246 ilişki (591 karşı seçim, 227 beceri eşleşmesi, 428 sinerji) içerir. Bu sayı bütün olası şampiyon çiftlerinin kapsandığı anlamına gelmez. Adresler kaynak dizininden çözülür; sup/bot koridorları ve farklı şampiyon adları desteklenir. Veri ayrıştırma hatası sunucu erişim sınırı olarak değerlendirilmez.
