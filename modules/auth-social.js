...
window.watchFriendGame = function(uid) {
    ...
    if (profile.activeMode === '1v1') window.enter1v1Game(profile.activeRoomCode || profile.activeRoomId);
    else if (profile.activeMode === '2v2') window.enter2v2Game(profile.activeRoomCode || profile.activeRoomId);
