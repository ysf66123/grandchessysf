import {traits,CONDITIONS} from './wild-rift-knowledge.mjs?v=20260924-items2';
import {itemAvailability,finalItemAvailable,finalBuildAvailable} from './wild-rift-evidence.mjs?v=20260924-items2';
import {guideQuality,championBuilds} from './wild-rift-quality.mjs?v=20260924-items2';
import {ITEM_ROLES,itemFacts,itemConflicts,itemFamily,BOOTS,SUPPORT_ITEMS,NEED_LABELS,RULES_PATCH,TRANSFORM_FROM} from './wild-rift-item-rules.mjs?v=20260924-items2';
import {championProfile,combatFacts,application,incompatibleItem,buildFit} from './wild-rift-build-fit.mjs?v=20260924-items2';
