...
export const CONDITIONS={
  ...
  'vs Critical Strike Damage':{key:'critical',label:'Girilen kritik vuruş eşyalarına karşı'},
  'vs Critial Strike Damage':{key:'critical',label:'Girilen kritik vuruş eşyalarına karşı'},
